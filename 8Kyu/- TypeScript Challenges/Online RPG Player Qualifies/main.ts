...
// My Solution
export function playerRankUp(points:number): boolean | string {
    return points < 100
      ? false
...
// Other Solutions
function playerRankUp(points:number) {
  const msg =
    "Well done! You have advanced to the qualifying stage. Win 2 out of your next 3 games to rank up.";
  return points > 99 ? msg : false;
}
...
// 3
const playerRankUp = (points:number) =>
  points >= 100 &&
  `Well done! You have advanced to the qualifying stage. Win 2 out of your next 3 games to rank up.`;